...
import com.alan.clients.mixins.impl.client.GuiScreenAccessor;
import com.alan.clients.module.impl.other.NameHider;
import com.alan.clients.module.impl.other.SlotHandler;
import com.alan.clients.module.impl.render.AntiShuffle;
...
public class Utils {
    ...
    static {
        Rise.getExecutor().scheduleWithFixedDelay(() -> {
