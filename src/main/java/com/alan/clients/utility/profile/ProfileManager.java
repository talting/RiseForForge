...
import com.alan.clients.clickgui.components.impl.CategoryComponent;
import com.alan.clients.module.Module;
import com.alan.clients.module.impl.client.Gui;
import com.alan.clients.module.impl.other.KillMessage;
import com.alan.clients.module.impl.render.HUD;
import com.alan.clients.module.impl.render.TargetHUD;
import com.alan.clients.module.impl.render.Watermark;
...
import com.alan.clients.module.setting.interfaces.InputSetting;
import com.alan.clients.script.Manager;
...
public class ProfileManager {
    ...
    public void saveProfile(Profile profile) {
        ...
        for (Module module : Rise.moduleManager.getModules()) {
        ...
        if (Rise.scriptManager != null && Rise.scriptManager.scripts != null) {
        ...
        for (File file : getProfileFiles()) {
            ...
            try (FileReader fileReader = new FileReader(file)) {
                ...
                for (JsonElement moduleJson : modules) {
                    ...
                    Module module = Rise.moduleManager.getModule(moduleName);
                    if (module == null && moduleName.startsWith("sc-") && Rise.scriptManager != null) {
                        for (Module module1 : Rise.scriptManager.scripts.values()) {
                    ...
                    Rise.currentProfile = getProfile(name);
                }
    ...
    public void loadProfiles() {
        ...
        if (directory.exists()) {
            ...
            Utils.sendMessage("&b" + Rise.profileManager.getProfileFiles().size() + " &7profiles loaded.");
        }
    }
