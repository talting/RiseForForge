...
import com.alan.clients.utility.ShaderUtils;
...
public class RRectUtils {
    public static final ShaderUtils roundedShader = new ShaderUtils("rise:shaders/rrect.frag");
    public static final ShaderUtils roundedOutlineShader = new ShaderUtils("rise:shaders/rrectOutline.frag");
    private static final ShaderUtils roundedGradientShader = new ShaderUtils("rise:shaders/rrectGradient.frag");
