package com.alan.clients.clickgui;
...
import com.alan.clients.clickgui.components.impl.BindComponent;
...
import com.alan.clients.module.impl.client.CommandLine;
...
import com.alan.clients.utility.render.GradientBlur;
...
public class ClickGui extends GuiScreen {
    ...
    public void initMain() {
        ...
        this.sf = Rise.getExecutor().schedule(() -> (this.aL = new Timer(650.0F)).start(), 650L, TimeUnit.MILLISECONDS);
    }
