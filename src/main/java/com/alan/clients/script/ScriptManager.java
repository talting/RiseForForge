...
public class ScriptManager {
    ...
    public ScriptManager() {
        directory = new File(Rise.mc.mcDataDir + File.separator + "keystrokes", "scripts");
    }
    ...
    private void parseFile(final File file) {
        ...
        Rise.scriptManager.scripts.put(script, module);
        Rise.scriptManager.invoke("onLoad", module);
    }
