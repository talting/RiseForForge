package com.alan.clients.mixins.impl.entity;
...
import com.alan.clients.module.impl.movement.fly.SpoofFly;
...
public abstract class MixinEntityPlayerSP extends AbstractClientPlayer {
    ...
    @Unique
    private boolean rise$isHeadspaceFree(BlockPos p_isHeadspaceFree_1_, int p_isHeadspaceFree_2_) {
    ...
    protected boolean pushOutOfBlocks(double p_pushOutOfBlocks_1_, double p_pushOutOfBlocks_3_, double p_pushOutOfBlocks_5_) {
        if (!this.noClip) {
            ...
            if (!this.rise$isHeadspaceFree(blockpos, entHeight)) {
                ...
                int i = -1;
                double d2 = 9999.0;
                if (this.rise$isHeadspaceFree(blockpos.west(), entHeight) && d0 < d2) {
                    d2 = d0;
                    i = 0;
                }

                if (this.rise$isHeadspaceFree(blockpos.east(), entHeight) && 1.0 - d0 < d2) {
                    d2 = 1.0 - d0;
                    i = 1;
                }

                if (this.rise$isHeadspaceFree(blockpos.north(), entHeight) && d1 < d2) {
                    d2 = d1;
                    i = 4;
                }

                if (this.rise$isHeadspaceFree(blockpos.south(), entHeight) && 1.0 - d1 < d2) {
                    i = 5;
                }
